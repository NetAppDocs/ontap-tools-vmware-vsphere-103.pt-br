...
. Exclua volumes FlexVol do ONTAP System Manager. Consulte  https://docs.netapp.com/us-en/ontap/volumes/delete-flexvol-task.html["Eliminar um FlexVol volume"^]. No comando da CLI para excluir um volume, forneça o nome exato dos volumes FlexVol.
. Exclua os igroups SAN do sistema de storage ONTAP em caso de implantação iSCSI. Consulte  https://docs.netapp.com/us-en/ontap/san-admin/manage-san-initiators-task.html["Visualizar e gerenciar iniciadores e grupos SAN"^].
