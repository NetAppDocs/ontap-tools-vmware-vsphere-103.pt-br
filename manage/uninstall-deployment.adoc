...
** Para movê-los para um armazenamento de dados não gerenciado, consulte https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/migrate-a-virtual-machine-with-storage-vmotion.html["Storage vMotion"^]
