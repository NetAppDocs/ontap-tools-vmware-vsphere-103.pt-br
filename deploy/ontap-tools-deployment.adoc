...
NOTE: Para obter mais informações, consulte o  https://blogs.vmware.com/vsphere/2020/01/creating-and-using-content-library.html["Criando e usando a Biblioteca de conteúdo"^]blog.
...
** O endereço IP da interconexão do nó é usado para comunicação interna.
